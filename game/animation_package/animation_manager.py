...
class Animation_Manager:
    ...
    def create_new_effect(self, frames, frame_length, looping=False, position=(0, 0)):
        new_anim_effect = Animation_Effect(self.surface, frames, frame_length, looping, position)
